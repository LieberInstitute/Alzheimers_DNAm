...
### Create boxplots
pdf('/dcl01/lieber/ajaffe/Steve/Alz/plots/best_ERC_subset_DMC_boxplots.pdf',height=10,width=12)
for (cpg_i in ERC_sigCpG) {

#Change column name for ggplot2 to work
ii=match(cpg_i, regionSpecific_mergedStats$Name)
fixName= paste(unique(unlist(strsplit(regionSpecific_mergedStats[ii,'UCSC_RefGene_Name'], ";"))), collapse = ", " )
custom_title = paste0( 
...
### Create boxplots
pdf('/dcl01/lieber/ajaffe/Steve/Alz/plots/best_DLPFC_subset_DMC_boxplots.pdf',height=10,width=12)
